...
<h1>Call for Posters</h1><br>

<p style="text-align: justify; text-indent: 2em;"><b>The 9th Asia-Pacific Workshop on Networking (APNet’25) will be held in Shanghai, China on August 7-8, 2025.</b></p>
<br>
...
<h2>Poster Chairs</h2>
<ul data-role="listview" data-inset="true" data-theme="a" data-content-theme="a" class="datetbl">
    <?php add_listitem("Xinggong Zhang", "Peking University", "https://scholar.google.com.hk/citations?user=WEpe1qUAAAAJ&hl=en"); ?>
    <?php add_listitem("Jiao Zhang", "Beijing University of Posts and Telecommunications", "https://scholar.google.com/citations?user=pWpI6H4AAAAJ&hl=en"); ?>
    <?php add_listitem("Zehua Guo", "Beijing Institute of Technology", "https://scholar.google.com.hk/citations?user=b0bPSfcAAAAJ&hl=en"); ?>
    <?php add_listitem("Lailong Luo", "National University of Defense Technologys", "https://scholar.google.com/citations?user=Ta1jm9wAAAAJ&hl=en"); ?>
    <?php add_listitem("Kaihui Gao", "Zhongguancun Laboratory", "https://gaokaihui.com/"); ?>
</ul>
