...
function add_registrationheader($regheadertype, $regheader1, $regheader2, $regheader3, $regheader4) {
...
?>
    <li data-icon="false">
      <div class="ui-grid-a">
        ...
        <div class="ui-block-b"><p><b><?php echo $regheader4 ?></b></p></div>
      </div>
    </li>
<?php
}

function add_registrationitem($regitemtype, $reginfo1, $reginfo2, $reginfo3, $reginfo4) {
...
?>
   <li data-icon="false">
     <div class="ui-grid-a">
       ...
       <div class="ui-block-b"><p><?php echo $reginfo4 ?></p></div>
     </div>
   </li>
<?php
