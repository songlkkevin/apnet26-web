...
<ul data-role="listview" data-inset="true" data-theme="a" data-content-theme="a" class="tbl">
  ...
  <?php
    ...
    add_listitem("Calvin Ardi", "ISI, USA", "https://www.isi.edu/directory/calvin/");
    ...
    add_listitem("Paolo Costa", "Microsoft Research, UK", "https://www.microsoft.com/en-us/research/people/pcosta/");
    ...
    add_listitem("Deke Guo", "NUDT, China", "https://scholar.google.com/citations?user=BQRNKssAAAAJ&hl=en");
    add_listitem("Dongsu Han", "KAIST, South Korea", "http://ina.kaist.ac.kr/~dongsuh/");
    add_listitem("Chen-Yu Ho", "ByteDance, USA", "https://www.chenyuho.com/");
    add_listitem("Zhuo Jiang", "ByteDance, China", "https://scholar.google.com/citations?user=qOX0mXMAAAAJ&hl=en");
    add_listitem("Daehyeok Kim", "University of Texas at Austin, USA", "https://daehyeok.kim/");
    ...
    add_listitem("Nik Sultana", "IIT, USA", "https://www.iit.edu/directory/people/nik-sultana");
    ...
    add_listitem("Fangxin Wang", "CUHK (Shenzhen), China", "https://mypage.cuhk.edu.cn/academics/wangfangxin/");
    add_listitem("Shuai Wang", "Zhongguancun Laboratory, China", "https://wangshuaizs.github.io/");
    add_listitem("Yuke Wang", "Rice University, USA", "https://profiles.rice.edu/faculty/yuke-wang");
