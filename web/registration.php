...
<p>Registration is done through: <a href="https://apnet2024.scimeeting.cn/en/web/index/21671_" rel="external">Registration Portal</a>.</p>
<p>Early-bird registration deadline is June 15, Anywhere on Earth</p>
...
<ul data-role="listview" data-inset="true" data-theme="a" data-content-theme="a" class="registration">
  <li data-role="list-divider">Registration fee (Early Registration is before June 15th, 2024, Anywhere on Earth)</li>
  <?php
...
<p>Each accepted paper must be accompanied by at least one full registration regardless of the status of the registering author, and an author must present the paper at the conference. Otherwise, the paper will be removed from the proceedings and ACM digital library. Please note that poster registration is separate; registering for a regular paper does not include poster registration, which must be done individually.</p>

<h2>Cancellation Policy</h2>

<p>All the payments are non-cancellable, non-refundable, and non-transferable after July 23. Refunds processed before this date will incur a US$100 administrative fee. For more information, please contact finance chair <a href="mailto:yangrw@pcl.ac.cn">RongWei Yang</a>.</p>
...
<p>APNet offers several student travel grants which cover the APNet conference registration (fully or partially). All applications will be reviewed based on the available budget and number of applications, which will determine the acceptance criteria.</p>
...
<h3>Application</h3>
<p>Applications have to be submitted by email to <a href="mailto:apnet2024-travelgrant@outlook.com">apnet2024-travelgrant@outlook.com</a>. The "Subject" line should contain "APNET 2025 grant application" and the student's name. The following information is requested from all applicants:</p>
<ul>
...
<h3>Note</h3>
<p>Receivers of an APNet Grant will register with a special promotion code. Therefore, applicants shall not register for the conference until they have received the notification of acceptance from the grant chair (sent before the early registration deadline).</p>
